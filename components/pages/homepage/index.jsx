      ...
      <div className="edina_tm_services" id="service">
        <div className="container">
          <div className="edina_tm_title">
            <h3>What I Do</h3>
            <p>
              Music for the upliftment of the soul and for the sake of fun is all that Music exists for and i do Music for the sake of Music
            </p>
          </div>
          {/* End edian_tm_title */}
          <Service />
      ...
      <div className="edina_tm_portfolio" id="portfolio">
        <div className="container">
          <div className="edina_tm_title">
            <h3>Portfolio</h3>
            <p>
              Check out my musical portfolio and connect with me........
            </p>
          </div>
          {/* End edian_tm_title */}
          <Portfolio />
